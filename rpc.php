	...
	if(!$db) {
		...
		if(isset($_POST['queryString'])) {
			...
			if(strlen($queryString) >0) {
				...
				$query = $db->query("SELECT * FROM filmes WHERE titulo LIKE '%$queryString%' OR titulo_original LIKE '%$queryString%' LIMIT 40");
				...
				if($query || $query2) {
					...
					echo "<span class='img'><img src='painel/imagens-posts/$imagem' width=\"40px\" height=\"54px\" alt=''></span>";
