...
<?php 
  $selecionaBanner = mysql_query("SELECT * FROM filmes ORDER BY id DESC LIMIT 4");
...
?>
 <selection class="slider-wrapper tamanho12">
        ...
        <?php while($lnBanner = mysql_fetch_array($selecionaBanner)){ 
          ...
          ?>
        	<a href="?single=true&id=<?php echo $bannerID; ?>"><img src="painel/imagens-posts/<?php echo $banner; ?>" alt="oi" title="<?php echo $titulo; ?>"></a>
        <?php }} ?>
        </div>
    </selection>        
